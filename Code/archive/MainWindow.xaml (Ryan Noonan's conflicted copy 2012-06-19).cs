...
namespace Microsoft.Samples.Kinect.SpeechBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void ControlMouse(Skeleton skeleton)
        {
            ...
            int cursorX;
            cursorX = (int)skeleton.Joints[JointType.HandRight].Position.X / SystemInformation.PrimaryMonitorSize.Width;

            int cursorY;
            cursorY = (int)skeleton.Joints[JointType.HandRight].Position.Y / SystemInformation.PrimaryMonitorSize.Height;

            System.Windows.Forms.Cursor.Position.X = cursorX;
        }
